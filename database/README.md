...
2. Start your PocketBase server and open the Admin Console (e.g., `http://localhost:8090/_/` or `https://pb-data.bitperfect.dedyn.io/_/`).
...
5. Under **Authorized redirect URIs**, add your PocketBase OAuth2 redirect URL:
   `https://pb-data.bitperfect.dedyn.io/api/oauth2-redirect`
