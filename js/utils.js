...
export const createSourceBadgeHTML = (item) => {
    ...
    if (provider === 'amazon') {
        return '<span class="quality-badge source-badge source-amazon" style="background-color: #00a8e1; color: #fff; margin-left: 4px; padding: 2px 6px; border-radius: 4px; font-size: 0.75rem; font-weight: 600; display: inline-block; vertical-align: middle;" title="Source: Amazon Music">AMAZON</span>';
    }
    if (provider === 'deezer') {
        return '<span class="quality-badge source-badge source-deezer" style="background-color: #a238ff; color: #fff; margin-left: 4px; padding: 2px 6px; border-radius: 4px; font-size: 0.75rem; font-weight: 600; display: inline-block; vertical-align: middle;" title="Source: Deezer">DEEZER</span>';
    }
